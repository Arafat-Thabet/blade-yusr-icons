...
use Yusr\BladeYusrIcons\Components\Svg as SvgComponent;
use Yusr\BladeYusrIcons\Exceptions\CannotRegisterIconSet;
use Yusr\BladeYusrIcons\Exceptions\SvgNotFound;
...
final class Factory
{
    ...
    private function splitSetAndName(string $name): array
    {
        ...
        return [$set ?? 'flaticon-regular', $name];
    }
